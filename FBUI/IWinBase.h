...
namespace fastbird
{
	...
	public:
		...
		virtual void SetHwndId(HWindowId hwndId) = 0;
		virtual void OnResolutionChanged(HWindowId hwndId) = 0;
		virtual HWindowId GetHwndId() const = 0;
		...
		virtual void GatherVisit(std::vector<UIObject*>& v) = 0;
		virtual void ModifySize(const Vec2I& sizemod) = 0;

		virtual void OnStartUpdate(float elapsedTime) = 0;
		virtual bool OnInputFromHandler(IInputInjectorPtr injector) = 0;
		...
		*/
		...
		virtual UIObjectPtr GetUIObj() const = 0;
